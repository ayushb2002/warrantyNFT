          ...
          <tr key={key1}>
            ...
            <td>
              <button
                ...
                onClick={(e) => clickNFT(e, key1, value1)}
              >
                Redeem!
              </button>
            </td>
          ...
          <tr key={key}>
            ...
            <td>
              <a
                ...
                target="_blank"
              >
                <button className="badge badge-error">View NFT!</button>
              </a>
            </td>
            <td>
              <button
                className="badge badge-warning"
                onClick={(e) => viewWarranty(e, value)}
              >
                View
              </button>
            </td>
      ...
      {connected && (
        <div className="grid grid-cols-2 w-[70vw]">
          ...
          <div className="m-10 col-span-2">
            <span className="text-3xl text-bold underline">
              Available tokens!
            </span>
          </div>
          ...
          <div className="mx-5 col-span-2">
            <table className="table table-zebra w-full">
              ...
              <tbody>{ownedNFT}</tbody>
            </table>
          </div>
        </div>
      )}
      {!connected && <div>Log in to access the page!</div>}
    </div>
  );
};
